...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // Emailof the user to login
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x08, 0x69, 0x73, 0x41, 0x64, 0x6d, 0x6d,
	...
	0x14, 0x5a, 0x12, 0x69, 0x6c, 0x6b, 0x68, 0x72, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b,
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auth.isAdmmin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.isAdmmin:output_type -> auth.IsAdminResponse
